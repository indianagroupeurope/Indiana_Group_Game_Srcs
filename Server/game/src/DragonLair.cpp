...
void CDragonLairManager::OpenRanking(LPCHARACTER pkChar)
{
	...
	std::auto_ptr<SQLMsg> pMsg(DBManager::Instance().DirectQuery("SELECT * FROM log.dragonlair_dungeon%s ORDER BY kill_count DESC, date ASC LIMIT 15;", get_table_postfix()));
